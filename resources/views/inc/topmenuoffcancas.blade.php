...
<div id="drawer-top-example"
    ...
    <button type="button" data-drawer-hide="drawer-top-example" aria-controls="drawer-top-example"
        class="text-white bg-transparent rounded-lg text-sm w-8 h-8 absolute top-14 end-2.5 inline-flex items-center justify-center dark:hover:bg-gray-600 dark:hover:text-white">
