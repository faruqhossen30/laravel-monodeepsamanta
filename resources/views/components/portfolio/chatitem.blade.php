<div class="group col-span-8 font-bold relative overflow-hidden text-white rounded-sm shadow">
    <!--layer start-->
    <div
        class="w-full absolute top-0 left-0 bg-gradient-to-t from-gray-800 opacity-70 hidden  group-hover:block transition">
    </div>

    <div class="max-w-[1260px] rounded-md mx-auto py-10 my-2 space-y-2 text-white text-center"
        ...
        <a href="{{ route('contactpage') }}"
            class="bg-primary py-2 px-6 inline-flex items-center gap-x-2 text-lg rounded-md text-white font-bold  shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 hover:text-[#FF003A]">
