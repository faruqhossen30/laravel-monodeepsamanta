<div  data-aos="zoom-in" data-aos-duration="1000" class="max-w-[1260px] h-full rounded-md mx-auto py-5 lg:py-[60px] my-5 lg:mt-[60px] space-y-2 text-white text-center"
    ...
    <button
        class="chat-button bg-primary py-2 px-6 inline-flex items-center gap-x-2 text-lg rounded-md text-white font-bold  shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 hover:text-[#FF003A]">
