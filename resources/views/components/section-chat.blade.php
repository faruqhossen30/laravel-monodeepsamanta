<div  data-aos="fade" data-aos-duration="1000" class="max-w-[1260px] h-full rounded-md mx-auto py-5 lg:py-[60px] my-5 lg:mt-[60px] space-y-2 text-white text-center"
