    ...
    <section class="grid grid-cols-12 gap-4">
        ...
        <div class="order-1 col-span-12 lg:col-span-4 lg:order-2" data-aos="fade-left" data-aos-duration="1000">
            <div class="w-full p-4 border rounded-md">
                ...
                <a href="skype:monodeep123" class="block w-full bg-black hover:bg-[#FF003A] text-white text-center text-base py-2 rounded-md my-3"
                    >Via Skype</a>

                <a href="mailto:monodeepsamanta@gmail.com" class="block w-full bg-black hover:bg-[#FF003A] text-white text-center text-base py-2 rounded-md my-3"
                    >Via Email</a>
            </div>
        </div>
    </section>
