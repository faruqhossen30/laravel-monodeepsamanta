...
<section class="grid grid-cols-12 gap-3">
    <div class=" col-span-8">
        <div class="space-y-2 text-lg mb-14 md:mb-0">
            <p>I am Monodeep Samanta, the leading UI/UX designer. I create designs that help your website turn
                ...
                locations.</p>
            <p>I am really good at what I do. People love my designs because they are easy to use with satisfying
        ...
        <div class="hidden md:block">
            <h1 class="flex items-center text-2xl space-x-2 py-4 mb-2 font-bold">
                <svg class="text-primary h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none"
            ...
            <button class="btn">Website Design</button> <button class="btn">App Design</button><button
                class="btn">Landing Page Design</button><button class="btn">Design Advice</button> <button
                class="btn">Graphic Design</button> <button class="btn">Web Design</button> <button
                class="btn">Logo Designesign Advice</button> <button class="btn">Adobe Photoshop</button>
            <button class="btn">WordPress</button> <button class="btn">Social media Marketing</button> <button
                class="btn">Digital Marketing</button> <button class="btn">Flyer Design</button> <button
                class="btn">UI Design</button><button class="btn">Digital Marketing</button> <button
                class="btn">UX Design</button>
        </div>
    </div>
    <div class="col-span-4">
        <div class="w-full border p-4 rounded-md">
            <div class="space-y-3">
                ...
                <P><span class="text-gray-500 text-sm font-semibold">English </span> <span
                        class="text-primary font-bold">Fluent</span></P>
                ...
                <div class="mt-3 space-x-6 inline-flex items-center">
                    <a class="inline-flex justify-center items-center w-10 h-10 text-center text-white hover:bg-primary bg-black hover:text-white hover:bg-[#FF003A] rounded-full focus:outline-none focus:ring-2  focus:ring-offset-2 focus:ring-offset-white transition dark:text-gray-500 dark:hover:text-gray-200 dark:hover:bg-gray-800" href="#">
                        <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg"  fill="currentColor" class="bi bi-behance" viewBox="0 0 16 16">
                    ...
                    <a class="inline-flex justify-center items-center w-10 h-10 text-center text-white hover:bg-primary bg-black hover:text-white hover:bg-[#FF003A] rounded-full focus:outline-none focus:ring-2  focus:ring-offset-2 focus:ring-offset-white transition dark:text-gray-500 dark:hover:text-gray-200 dark:hover:bg-gray-800" href="#">
                        <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-dribbble" viewBox="0 0 16 16">
                    ...
                    <a class="inline-flex justify-center items-center w-10 h-10 text-center text-white hover:bg-primary bg-black hover:text-white hover:bg-[#FF003A] rounded-full focus:outline-none focus:ring-2  focus:ring-offset-2 focus:ring-offset-white transition dark:text-gray-500 dark:hover:text-gray-200 dark:hover:bg-gray-800" href="#">
                        <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16">
            ...
            <a class="block w-full bg-black hover:bg-[#FF003A] text-white text-center text-base py-2 rounded-md my-3" href="#">Via What's App</a>

            <a class="block w-full bg-black hover:bg-[#FF003A] text-white text-center text-base py-2 rounded-md my-3" href="#">Via Skype</a>

            <a class="block w-full bg-black hover:bg-[#FF003A] text-white text-center text-base py-2 rounded-md my-3" href="#">Via Email</a>
        </div>
    </div>
</section>
