...
<div class="grid grid-cols-12 gap-3">
    ...
    <a href="{{route('singleservice', $service->slug)}}" class="col-span-12 p-3 border group md:col-span-6 lg:col-span-4" data-aos="fade" data-aos-duration="2000">
        ...
        <div class="py-2 mt-5 space-y-1">
            ...
            <h2 class="text-lg font-normal text-primary">Starting at ${{ $service->package->starter_price ?? '' }}</h2>
        </div>
    </a>
    @endforeach
    <div class="pt-5">
