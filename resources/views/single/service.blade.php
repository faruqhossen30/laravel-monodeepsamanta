...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-4">
        <div class="col-span-12 lg:col-span-8">
            <h1 class="text-[26px] leading-[32px] py-2 font-bold">{{ $service->title }}</h1>
                ...
                <div class="border p-2 sticky top-36">
                    ...
                    <div class="mt-3">
                        <div id="equal-width-elements-1" role="tabpanel" aria-labelledby="equal-width-elements-item-1">
                            <h1 class="text-[26px] leading-[32px] py-2 font-bold">${{ optional($service->package)->starter_price }}</h1>
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <h1 class="text-[26px] leading-[32px] py-2 font-bold">{{ $service->package->starter_deliver_time }} Days Delivery
                                </h1>
                            </div>
                            <div class="py-2">
                        ...
                        <div id="equal-width-elements-2" class="hidden" role="tabpanel"
                            ...
                            <h1 class="text-[26px] leading-[32px] py-2 font-bold">${{ $service->package->standard_price }}</h1>
                            <div class="flex items-center space-x-1">
                                <span class="text-md font-bold">Save up to 10% with <span class="text-primary">Subscribe
                                        to
                                        save</span></span>
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <h1 class="text-[26px] leading-[32px] py-2 font-bold">{{ $service->package->standard_deliver_time }} Days Delivery
                                </h1>
                            </div>
                            <div class="py-2">
                                {!! $service->package->standard_short_description !!}
                        ...
                        <div id="equal-width-elements-3" class="hidden" role="tabpanel"
                            ...
                            <h1 class="text-[26px] leading-[32px] py-2 font-bold">${{ $service->package->advance_price }}</h1>
                            <div class="flex items-center space-x-1">
                                <span class="text-md font-bold">Save up to 10% with <span class="text-primary">Subscribe
                                        to
                                        save</span></span>
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <h1 class="text-[26px] leading-[32px] py-2 font-bold">{{ $service->package->advance_deliver_time }} Days Delivery
                                </h1>
                            </div>
                            <div class="py-3">
