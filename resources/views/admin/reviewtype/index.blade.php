...
@section('content')
<x-dashboard.breadcrumb title="reviewtype"  route="reviewtype.index" />
                ...
                <div class="p-1.5 min-w-full inline-block align-middle">
                    <div class="border rounded-lg divide-y divide-gray-200 dark:border-gray-700 dark:divide-gray-700">
                        <div class="flex justify-between py-3 px-4">
                            ...
                            <a href="{{ route('reviewtype.create') }}"
                        ...
                        <div class="overflow-hidden">
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    @foreach ($types as $reviewtype)
                                        <tr class="bg-white hover:bg-gray-50 dark:bg-slate-900 dark:hover:bg-slate-800">
                                            <td
                                                class="px-3 py-2 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">{{$types->firstItem() + $loop->index}}</td>
                                            <td
                                                class="px-3 py-2 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">
                                                {{$reviewtype->name}}</td>

                                            <td class="px-3 py-2 whitespace-nowrap text-right text-sm font-medium">
                                                <x-table.action_button route="reviewtype" :id="$reviewtype->id"/>
                                            </td>
                                        </tr>
                                    @endforeach
