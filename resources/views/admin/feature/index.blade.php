...
@section('content')
<x-dashboard.breadcrumb title="Features"  route="feature.index" />
                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead class="bg-gray-50 dark:bg-gray-700">
                                    <tr>
                                        ...
                                        <th scope="col"
                                            class="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase">Default Value
                                        </th>
                                        <th scope="col"
                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    @foreach ($features as $feature)
                                        <tr class="bg-white hover:bg-gray-50 dark:bg-slate-900 dark:hover:bg-slate-800">
                                            <td
                                                class="px-3 py-2 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">{{$features->firstItem() + $loop->index}}</td>
                                            <td
                                            ...
                                            <td class="px-3 py-2 whitespace-nowrap text-right text-sm font-medium">
                                                <x-table.action_button route="feature" :id="$feature->id"/>
                                            </td>
                                        </tr>
                                    @endforeach
