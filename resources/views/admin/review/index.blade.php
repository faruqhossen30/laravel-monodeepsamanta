                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead class="bg-gray-50 dark:bg-gray-700">
                                    <tr>
                                        ...
                                        <th scope="col"
                                            class="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase">Buyer
                                        </th>
                                        <th scope="col"
                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    @foreach ($reviews as $item)
                                        <tr class="bg-white hover:bg-gray-50 dark:bg-slate-900 dark:hover:bg-slate-800">
                                            ...
                                            {{-- <td
                                                class="px-3 py-2 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">
                                                <img src="{{asset('uploads/review/'.$item->thumbnail)}}" class="h-6 w-auto" alt="">
                                            </td> --}}

                                            <td
                                                class="px-3 py-2 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">
                                                <img src="{{ asset('uploads/review/' . $item->thumbnail) }}"
                                            ...
                                            <td class="px-3 py-2 whitespace-nowrap text-right text-sm font-medium">
                                                <x-table.action_button route="review" :id="$item->id" />
                                            </td>
                                        </tr>
                                    @endforeach
