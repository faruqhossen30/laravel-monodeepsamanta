...
@section('content')
<x-dashboard.breadcrumb title="GalleryCategory"  route="gallery-category.index" />
                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    @foreach ($gallerycategory as $category)
                                        <tr class="bg-white hover:bg-gray-50 dark:bg-slate-900 dark:hover:bg-slate-800">
                                            <td
                                                class="px-3 py-2 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">{{$gallerycategory->firstItem() + $loop->index}}</td>
                                            ...
                                            <td class="px-3 py-2 whitespace-nowrap text-right text-sm font-medium">
                                                <x-table.action_button route="gallery-category" :id="$category->id"/>
                                            </td>
                                        </tr>
                                    @endforeach
