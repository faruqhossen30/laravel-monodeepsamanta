    ...
    <div class="flex items-center max-w-[1260px] mx-auto justify-between bg-white mt-2 z-50">
        ...
        <div class="mt-1">
            ...
            <div class="hidden md:flex items-center justify-end space-y-1 space-x-1">
                <svg class="text-brand w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
...
<section class="hidden md:block bg-white border-b z-0">
    <nav class="max-w-[1260px] mx-auto bg-white flex space-x-6">
        <a href="{{ route('homepage') }}"
            class="@if (request()->routeIs('homepage')) border-b-2 border-b-[#FF003A] text-brand @endif inline-flex items-center gap-x-2 text-lg leading-[21px] whitespace-nowrap text-gray-400 hover:text-blue-70 focus:outline-none dark:text-blue-500 dark:focus:text-blue-400 menuhover pb-2">
            Home
        </a>
        ...
        <a href="{{ route('aboutpage') }}"
            class="@if (request()->routeIs('aboutpage')) border-b-2 border-b-[#FF003A] text-brand @endif inline-flex items-center gap-x-2 text-lg leading-[21px] whitespace-nowrap text-gray-400 hover:text-blue-70 focus:outline-none dark:text-blue-500 dark:focus:text-blue-400 menuhover pb-2">
            About Me
        </a>
        ...
        <a href="{{ route('reviewpage') }}"
            class="@if (request()->routeIs('reviewpage')) border-b-2 border-b-[#FF003A] text-brand @endif inline-flex items-center gap-x-2 text-lg leading-[21px] whitespace-nowrap text-gray-400 hover:text-blue-70 focus:outline-none dark:text-blue-500 dark:focus:text-blue-400 menuhover pb-2">
            Reviews
        </a>
