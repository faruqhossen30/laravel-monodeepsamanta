<footer class=" py-28 pb-16 px-4 sm:px-6 lg:px-8 mx-auto bg-black">
    ...
    <div class="text-center ">
      ...
      <div class="mt-6 space-x-4  lg:space-x-9 inline-flex items-center">
        ...
        <a href="https://dribbble.com/monodeepsamanta" target="_blank" class="inline-flex justify-center items-center w-10 lg:w-16 h-10 lg:h-16 text-center text-black hover:bg-primary bg-white hover:text-white hover:bg-[#FF003A] rounded-full focus:outline-none focus:ring-2  focus:ring-offset-2 focus:ring-offset-white transition dark:text-gray-500 dark:hover:text-gray-200 dark:hover:bg-gray-800">
            <svg class="w-6 h-6 lg:w-8 lg:h-8" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-dribbble" viewBox="0 0 16 16">
        ...
        <a href="https://www.linkedin.com/in/monodeepsamanta/" target="_blank" class="inline-flex justify-center items-center w-10 lg:w-16 h-10 lg:h-16 text-center text-black hover:bg-primary bg-white hover:text-white hover:bg-[#FF003A] rounded-full focus:outline-none focus:ring-2  focus:ring-offset-2 focus:ring-offset-white transition dark:text-gray-500 dark:hover:text-gray-200 dark:hover:bg-gray-800">
            <svg class="w-6 h-6 lg:w-8 lg:h-8" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16">
      ...
      <!-- End Social Brands -->
      <div class=" mt-11">
        <p class="text-white text-sm">© Copyright {{date('Y')}}  reserved by Monodeep Samanta.</p>
      </div>
    </div>
    <!-- End Grid -->
  </footer>
