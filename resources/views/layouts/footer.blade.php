<footer class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto bg-black">
    <!-- Grid -->
    <div class="text-center">
      ...
      <div class="mt-3 space-x-6 inline-flex items-center">
        <a class="inline-flex justify-center items-center w-16 h-16 text-center text-black hover:bg-primary bg-white hover:text-white hover:bg-[#FF003A] rounded-full focus:outline-none focus:ring-2  focus:ring-offset-2 focus:ring-offset-white transition dark:text-gray-500 dark:hover:text-gray-200 dark:hover:bg-gray-800" href="#">
            <svg class="w-8 h-8" xmlns="http://www.w3.org/2000/svg"  fill="currentColor" class="bi bi-behance" viewBox="0 0 16 16">
        ...
        <a class="inline-flex justify-center items-center w-16 h-16 text-center text-black hover:bg-primary bg-white hover:text-white hover:bg-[#FF003A] rounded-full focus:outline-none focus:ring-2  focus:ring-offset-2 focus:ring-offset-white transition dark:text-gray-500 dark:hover:text-gray-200 dark:hover:bg-gray-800" href="#">
            <svg class="w-8 h-8" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-dribbble" viewBox="0 0 16 16">
        ...
        <a class="inline-flex justify-center items-center w-16 h-16 text-center text-black hover:bg-primary bg-white hover:text-white hover:bg-[#FF003A] rounded-full focus:outline-none focus:ring-2  focus:ring-offset-2 focus:ring-offset-white transition dark:text-gray-500 dark:hover:text-gray-200 dark:hover:bg-gray-800" href="#">
            <img class="h-6 w-6" src="{{asset('img/icon/flickr-website-logo-silhouette.png')}}" alt="">
        </a>
        <a class="inline-flex justify-center items-center w-16 h-16 text-center text-black hover:bg-primary bg-white hover:text-white hover:bg-[#FF003A] rounded-full focus:outline-none focus:ring-2  focus:ring-offset-2 focus:ring-offset-white transition dark:text-gray-500 dark:hover:text-gray-200 dark:hover:bg-gray-800" href="#">
            <img class="h-6 w-6" src="{{asset('img/icon/500px-monogram.png')}}" alt="">
        </a>
        <a class="inline-flex justify-center items-center w-16 h-16 text-center text-black hover:bg-primary bg-white hover:text-white hover:bg-[#FF003A] rounded-full focus:outline-none focus:ring-2  focus:ring-offset-2 focus:ring-offset-white transition dark:text-gray-500 dark:hover:text-gray-200 dark:hover:bg-gray-800" href="#">
            <svg class="w-8 h-8" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16">
