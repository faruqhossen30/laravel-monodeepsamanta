...
@section('content')
    <div>
                    ...
                    <div class="border overflow-hidden dark:border-gray-700">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            <thead>
                                <tr>
                                    <th scope="col"
                                        class="px-4 py-3 text-start text-lg font-medium text-gray-500 uppercase">Photo</th>
                                    <th scope="col"
                                        class="px-4 py-3 text-start text-lg font-medium text-gray-500 uppercase">Service</th>
                                    <th scope="col"
                                        class="px-4 py-3 text-start text-lg font-medium text-gray-500 uppercase">Package
                                    </th>
                                    <th scope="col"
                                        class="px-4 py-3 text-start text-lg font-medium text-gray-500 uppercase">Price</th>
                                    <th scope="col"
                                        class="px-4 py-3 text-start text-lg font-medium text-gray-500 uppercase">QTY</th>
                                    <th scope="col"
                                        class="px-4 py-3 text-end text-lg font-medium text-gray-500 uppercase">Aciton</th>
                                </tr>
                            </thead>
        ...
        @else
        <div class="my-10 bg-white border border-gray-200 shadow-sm rounded-xl p-4 md:p-5 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400">
